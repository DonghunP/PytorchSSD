...
parser.add_argument('-v', '--version', default='FFSSD_vgg', help='RFB_vgg ,RFB_E_vgg RFB_mobile SSD_vgg version.')
...
parser.add_argument('-b', '--batch_size', default=24, type=int, help='Batch size for training')
...
parser.add_argument('--date', default='0930')
...
if args.version == 'RFB_vgg':
    ...
    from models.FFSSD_vgg import build_net
...
if args.ngpu > 1:
    ...
    net = torch.nn.DataParallel(net, device_ids=id)
